// Generated by Sichem at 14.04.2017 10:34:54
...
namespace StbSharp
{
	unsafe partial class Stb
	{
		...
		public static void* setup_malloc(stb_vorbis f, int sz)
		{
			...
			return (sz) != 0 ? malloc((ulong) (sz)) : ((void*) (0));
		}
		...
		public static void* setup_temp_malloc(stb_vorbis f, int sz)
		{
			...
			if ((f.alloc.alloc_buffer) != null)
			{
				if ((f.temp_offset - sz) < (f.setup_offset)) return ((void*) (0));
				f.temp_offset -= (int) (sz);
				return f.alloc.alloc_buffer + f.temp_offset;
			}

			return malloc((ulong) (sz));
		}
		...
		{
			return (uint) ((crc << 8) ^ crc_table[b ^ (crc >> 24)]);
		}
		...
		public static float float32_unpack(uint x)
		{
			...
			return (float) (ldexp((double) ((float) (res)), (int) (exp - 788)));
		}
		...
		public static int compute_codewords(Codebook* c, byte* len, int n, uint* values)
		{
			...
			memset(available, (int) (0), (ulong) (sizeof ((available))))
			;
			for (k = (int) (0); (k) < (n); ++k)
			{
				if ((len[k]) < (255)) break;
		...
		public static void compute_sorted_huffman(Codebook* c, byte* lengths, uint* values)
		{
			...
			qsort(c->sorted_codewords, (ulong) (c->sorted_entries), (ulong) (sizeof ((c->sorted_codewords[0]))),
			uint32_compare)
			;
		...
		public static int vorbis_validate(byte* data)
		{
			...
			return (int) ((memcmp(data, vorbis, (ulong) (6))) == (0) ? 1 : 0);
		}

		public static int lookup1_values(int entries, int dim)
		{
			int r = (int) (floor((double) (exp((double) ((float) (log((double) ((float) (entries))))/dim)))));
			if ((int) (floor((double) (pow((double) ((float) (r) + 1), (double) (dim))))) <= entries) ++r;
			return (int) (r);
		}
		...
		public static void compute_twiddle_factors(int n, float* A, float* B, float* C)
		{
			...
			{
				A[k2] = ((float) (cos((double) (4*k*3.14159265358979323846264f/n))));
				A[k2 + 1] = ((float) (-sin((double) (4*k*3.14159265358979323846264f/n))));
				B[k2] = (float) ((float) (cos((double) ((k2 + 1)*3.14159265358979323846264f/n/2)))*0.5f);
				B[k2 + 1] = (float) ((float) (sin((double) ((k2 + 1)*3.14159265358979323846264f/n/2)))*0.5f);
			}
			for (k = (int) (k2 = (int) (0)); (k) < (n8); ++k , k2 += (int) (2))
			{
				C[k2] = ((float) (cos((double) (2*(k2 + 1)*3.14159265358979323846264f/n))));
				C[k2 + 1] = ((float) (-sin((double) (2*(k2 + 1)*3.14159265358979323846264f/n))));
			}
		}
						...
						(sin(
							(double)
								(0.5*3.14159265358979323846264f*
								 square((float) (sin((double) ((i - 0 + 0.5)/n2*0.5*3.14159265358979323846264f))))))));
			}
		}
		...
		public static int init_blocksize(stb_vorbis f, int b, int n)
		{
			...
			f.bit_reverse[b] = (ushort*) (setup_malloc(f, (int) (sizeof (uint16)**n8)));
		...
		{
			uint z;
			if ((f.valid_bits) < (0)) return (uint) (0);
			if ((f.valid_bits) < (n))
			{
				if ((n) > (24))
				{
					z = (uint) (get_bits(f, (int) (24)));
					z += (uint) (get_bits(f, (int) (n - 24)) << 24);
					return (uint) (z);
				}
				if ((f.valid_bits) == (0)) f.acc = (uint) (0);
				while ((f.valid_bits) < (n))
				{
					int z = (int) (get8_packet_raw(f));
					if ((z) == (-1))
					{
						f.valid_bits = (int) (-1);
						return (uint) (0);
		...
		public static int codebook_decode_scalar_raw(stb_vorbis f, Codebook* c)
		{
			int i;
			prep_huffman(f);
			if (((c->codewords) == ((void*) (0))) && ((c->sorted_codewords) == ((void*) (0)))) return (int) (-1);
			if (((c->entries) > (8) ? c->sorted_codewords != ((void*) (0)) : !c->codewords) != 0)
			{
		...
		public static int codebook_decode_start(stb_vorbis f, Codebook* c)
		{
			...
			else
			{
				...
				z = (int) (f.acc & ((1 << 10) - 1));
				z = (int) (c->fast_huffman[z]);
				if ((z) >= (0))
				{
					int n = (int) (c->codeword_lengths[z]);
					f.acc >>= n;
					f.valid_bits -= (int) (n);
					if ((f.valid_bits) < (0))
					{
				...
				{
					z = (int) (codebook_decode_scalar_raw(f, c));
				}
				if ((c->sparse) != 0) ;
				if ((z) < (0))
				{
		...
		public static void draw_line(float* output, int x0, int y0, int x1, int y1, int n)
		{
			...
			int sy;
			base = (int) (dy/adx);
			if ((dy) < (0)) sy = (int) (base - 1);
			else sy = (int) (base + 1);
			ady -= (int) (abs((int) (base))*adx);
			if ((x1) > (n)) x1 = (int) (n);
			if ((x) < (x1))
			{
		...
		public static void decode_residue(stb_vorbis f, float*[] residue_buffers, int ch, int n, int rn, byte* do_not_decode)
		{
			...
			byte*** part_classdata =
				(byte***)
					(make_block_array((f.alloc.alloc_buffer
						? setup_temp_malloc(f, (int) (f.channels*(sizeof (void*) + +(part_read*sizeof ((**part_classdata)))))):
			_alloca((ulong) (f.channels*(sizeof (void*) + +(part_read*sizeof ((**part_classdata))))))),
			(int) (f.channels),
			(int) (part_read*sizeof (
			(**part_classdata)))))
			;
			for (i = (int) (0); (i) < (ch); ++i)
			{
				if (do_not_decode[i] == 0) memset(residue_buffers[i], (int) (0), (ulong) (sizeof (float)**n));
			}
			if (((rtype) == (2)) && (ch != 1))
			{
				for (j = (int) (0); (j) < (ch); ++j)
					...
					if ((ch) == (2))
					{
						while ((pcount) < (part_read))
						{
							...
							if ((pass) == (0))
							{
								...
								if ((f.valid_bits) < (10)) prep_huffman(f);
								q = (int) (f.acc & ((1 << 10) - 1));
								q = (int) (c->fast_huffman[q]);
								if ((q) >= (0))
								{
									int n = (int) (c->codeword_lengths[q]);
									f.acc >>= n;
									f.valid_bits -= (int) (n);
									if ((f.valid_bits) < (0))
									{
								...
								{
									q = (int) (codebook_decode_scalar_raw(f, c));
								}
								if ((c->sparse) != 0) q = (int) (c->sorted_values[q]);
								if ((q) == (-1)) goto done;
					...
					if ((pass) == (0))
					{
						for (j = (int) (0); (j) < (ch); ++j)
						{
							if (do_not_decode[j] == 0)
							{
								...
								int temp;
								if ((f.valid_bits) < (10)) prep_huffman(f);
								temp = (int) (f.acc & ((1 << 10) - 1));
								temp = (int) (c->fast_huffman[temp]);
								if ((temp) >= (0))
								{
									int n = (int) (c->codeword_lengths[temp]);
									f.acc >>= n;
									f.valid_bits -= (int) (n);
									if ((f.valid_bits) < (0))
									{
								...
								{
									temp = (int) (codebook_decode_scalar_raw(f, c));
								}
						...
						for (j = (int) (0); (j) < (ch); ++j)
						{
							if (do_not_decode[j] == 0)
							{
								...
								if ((b) >= (0))
								{
									...
									Codebook* book = f.codebooks + b;
									if (residue_decode(f, book, target, (int) (offset), (int) (n), (int) (rtype)) == 0) goto done;
								}
							}
						}
					}
		...
		public static void inverse_mdct(float* buffer, int n, stb_vorbis f, int blocktype)
		{
			...
			float* buf2 = (float*) (f.alloc.alloc_buffer ? setup_temp_malloc(f, (int) (n2*sizeof ((*buf2)))):
			_alloca((ulong) (n2*sizeof ((*buf2)))))
			;
			float* u = ((void*) (0));
			float* v = ((void*) (0));
			...
			int right_start, int right_end, int* p_left)
		{
					...
					if ((get_bits(f, (int) (1))) != 0)
					{
						...
						for (j = (int) (0); (j) < (g->partitions); ++j)
						{
							...
							if ((cbits) != 0)
							{
								...
								if ((f.valid_bits) < (10)) prep_huffman(f);
								cval = (int) (f.acc & ((1 << 10) - 1));
								cval = (int) (c->fast_huffman[cval]);
								if ((cval) >= (0))
								{
									int n = (int) (c->codeword_lengths[cval]);
									f.acc >>= n;
									f.valid_bits -= (int) (n);
									if ((f.valid_bits) < (0))
									{
								...
								{
									cval = (int) (codebook_decode_scalar_raw(f, c));
								}
			...
			if ((f.alloc.alloc_buffer) != null) ;
			memcpy(really_zero_channel, zero_channel, (ulong) (sizeof ((really_zero_channel[0]))
			*f.channels))
			;
			...
			for (i = (int) (map->coupling_steps - 1); (i) >= (0); --i)
			{
				...
				for (j = (int) (0); (j) < (n2); ++j)
				{
					float a2;
					float m2;
					if ((m[j]) > (0)) if ((a[j]) > (0)) m2 = (float) (m[j]) ,
					a2 = (float) (m[j] - a[j]);
				else
					a2 = (float) (m[j]) ,
					m2 = (float) (m[j] + a[j]);
				else
					if ((a[j]) > (0)) m2 = (float) (m[j]) ,
					a2 = (float) (m[j] + a[j]);
				else
					a2 = (float) (m[j]) ,
					m2 = (float) (m[j] - a[j]);
			...
			for (i = (int) (0); (i) < (f.channels); ++i)
			{
				...
				{
					memset(f.channel_buffers[i], (int) (0), (ulong) (sizeof ((*f.channel_buffers[i]))
					*n2))
					;
				}
				else
				{
					do_floor(f, map, (int) (i), (int) (n), f.channel_buffers[i], f.finalY[i], ((void*) (0)));
				}
			}
			for (i = (int) (0); (i) < (f.channels); ++i)
			{
			...
			{
				if (((f.current_loc_valid) != 0) && (f.page_flag & 4))
				{
		...
		public static int vorbis_decode_packet(stb_vorbis f, int* len, int* p_left, int* p_right)
		{
			...
			return
				(int)
					(vorbis_decode_packet_rest(f, len, f.mode_config + mode, (int) (*p_left), (int) (left_end), (int) (*p_right),
						(int) (right_end), p_left));
		}
				...
				for (i = (int) (0); (i) < (f.channels); ++i)
				{
					for (j = (int) (0); (j) < (n); ++j)
					{
						f.channel_buffers[i][left + j] =
							(float) (f.channel_buffers[i][left + j]*w[j] + f.previous_window[i][j]*w[n - 1 - j]);
					}
				}
			}
		...
		public static int is_whole_packet_present(stb_vorbis f, int end_page)
		{
			...
			for ((s) == (-1);;)
			{
				...
				if ((memcmp(p, ogg_page_header, (ulong) (4))) != 0) return (int) (error(f, (int) (VORBIS_invalid_stream)));
				if (p[4] != 0) return (int) (error(f, (int) (VORBIS_invalid_stream)));
				if ((first) != 0)
				{
					if ((f.previous_length) != 0) if ((p[5] & 1)) return (int) (error(f, (int) (VORBIS_invalid_stream)));
				}
				else
				{
		...
		public static int start_decoder(stb_vorbis f)
		{
			...
			f.codebooks = (Codebook*) (setup_malloc(f, (int) (sizeof ((*f.codebooks))*f.codebook_count)))
			;
			if ((f.codebooks) == ((void*) (0))) return (int) (error(f, (int) (VORBIS_outofmem)));
			memset(f.codebooks, (int) (0), (ulong) (sizeof ((*f.codebooks))
			*f.codebook_count))
			;
			for (i = (int) (0); (i) < (f.codebook_count); ++i)
			{
				...
				if ((ordered) != 0)
				{
					...
					while ((current_entry) < (c->entries))
					{
						...
						memset(lengths + current_entry, (int) (current_length), (ulong) (n));
						current_entry += (int) (n);
						++current_length;
					}
				}
				...
				if (((c->sparse) != 0) && ((total) >= (c->entries >> 2)))
				{
					...
					if ((c->codeword_lengths) == ((void*) (0))) return (int) (error(f, (int) (VORBIS_outofmem)));
					memcpy(c->codeword_lengths, lengths, (ulong) (c->entries));
				...
				if (c->sparse == 0)
				{
					c->codewords = (uint*) (setup_malloc(f, (int) (sizeof ((c->codewords[0]))*c->entries)))
					;
				...
				else
				{
					...
					if ((c->sorted_entries) != 0)
					{
						...
						c->codewords = (uint*) (setup_temp_malloc(f, (int) (sizeof ((*c->codewords))*c->sorted_entries)))
						;
						if (c->codewords == null) return (int) (error(f, (int) (VORBIS_outofmem)));
						values = (uint*) (setup_temp_malloc(f, (int) (sizeof ((*values))*c->sorted_entries)))
						;
						if (values == null) return (int) (error(f, (int) (VORBIS_outofmem)));
					}
					size = (uint) (c->entries + (sizeof (
					(*c->codewords))
					+sizeof (
					(*values)))
					*c->sorted_entries)
				...
				if ((c->sorted_entries) != 0)
				{
					c->sorted_codewords = (uint*) (setup_malloc(f, (int) (sizeof ((*c->sorted_codewords))*(c->sorted_entries + 1))))
					;
					if ((c->sorted_codewords) == ((void*) (0))) return (int) (error(f, (int) (VORBIS_outofmem)));
					c->sorted_values = (int*) (setup_malloc(f, (int) (sizeof ((*c->sorted_values))*(c->sorted_entries + 1))))
					;
					if ((c->sorted_values) == ((void*) (0))) return (int) (error(f, (int) (VORBIS_outofmem)));
					++c->sorted_values;
				...
				if ((c->sparse) != 0)
				{
					setup_temp_free(f, values, (int) (sizeof ((*values))
					*c->sorted_entries))
					;
					setup_temp_free(f, c->codewords, (int) (sizeof ((*c->codewords))
					*c->sorted_entries))
					;
					setup_temp_free(f, lengths, (int) (c->entries));
					c->codewords = ((void*) (0));
				...
				if ((c->lookup_type) > (0))
				{
					...
					mults = (ushort*) (setup_temp_malloc(f, (int) (sizeof ((mults[0]))*c->lookup_values)))
					;
					if ((mults) == ((void*) (0))) return (int) (error(f, (int) (VORBIS_outofmem)));
					for (j = (int) (0); (j) < ((int) (c->lookup_values)); ++j)
					{
						int q = (int) (get_bits(f, (int) (c->value_bits)));
						if ((q) == (-1))
						{
							setup_temp_free(f, mults, (int) (sizeof ((mults[0]))
							*c->lookup_values))
							;
							return (int) (error(f, (int) (VORBIS_invalid_setup)));
						}
					...
					if ((c->lookup_type) == (1))
					{
						...
						if ((sparse) != 0)
						{
							...
							c->multiplicands = (float*) (setup_malloc(f, (int) (sizeof ((c->multiplicands[0]))*c->sorted_entries*
							                   c->dimensions)))
							;
						}
						else
							c->multiplicands = (float*) (setup_malloc(f, (int) (sizeof ((c->multiplicands[0]))*c->entries*c->dimensions)))
						;
						if ((c->multiplicands) == ((void*) (0)))
						{
							setup_temp_free(f, mults, (int) (sizeof ((mults[0]))
							*c->lookup_values))
							;
					...
					{
						float last = (float) (0);
						c->multiplicands = (float*) (setup_malloc(f, (int) (sizeof ((c->multiplicands[0]))*c->lookup_values)))
						;
						if ((c->multiplicands) == ((void*) (0)))
						{
							setup_temp_free(f, mults, (int) (sizeof ((mults[0]))
			...
			f.floor_config = (Floor*) (setup_malloc(f, (int) (f.floor_count*sizeof ((*f.floor_config)))))
			;
			if ((f.floor_config) == ((void*) (0))) return (int) (error(f, (int) (VORBIS_outofmem)));
				...
				else
				{
					...
					for (j = (int) (0); j <= max_class; ++j)
					{
						...
						for (k = (int) (0); (k) < (1 << g->class_subclasses[j]); ++k)
						{
							...
							if ((g->subclass_books[j][k]) >= (f.codebook_count)) return (int) (error(f, (int) (VORBIS_invalid_setup)));
						}
					}
					...
					qsort(p, (ulong) (g->values), (ulong) (sizeof ((p[0]))),
					point_compare)
					;
					for (j = (int) (0); (j) < (g->values); ++j)
					{
			...
			f.residue_config = (Residue) (setup_malloc(f, (int) (f.residue_count*sizeof ((f.residue_config[0])))))
			;
			if ((f.residue_config) == ((void*) (0))) return (int) (error(f, (int) (VORBIS_outofmem)));
			memset(f.residue_config, (int) (0), (ulong) (f.residue_count*sizeof ((f.residue_config[0]))))
			;
			for (i = (int) (0); (i) < (f.residue_count); ++i)
			{
				...
				r.residue_books = (short [
				8]
				*)
				(setup_malloc(f, (int) (sizeof ((r.residue_books[0]))*r.classifications)))
				;
				if ((r.residue_books) == ((void*) (0))) return (int) (error(f, (int) (VORBIS_outofmem)));
				for (j = (int) (0); (j) < (r.classifications); ++j)
				{
					for (k = (int) (0); (k) < (8); ++k)
					{
				...
				r.classdata = (byte**) (setup_malloc(f, (int) (sizeof ((*r.classdata))*f.codebooks[r.classbook].entries)))
				;
				if (r.classdata == null) return (int) (error(f, (int) (VORBIS_outofmem)));
				memset(r.classdata, (int) (0), (ulong) (sizeof ((*r.classdata))
				*f.codebooks[r.classbook].entries))
				...
				for (j = (int) (0); (j) < (f.codebooks[r.classbook].entries); ++j)
				{
					...
					;
					if ((r.classdata[j]) == ((void*) (0))) return (int) (error(f, (int) (VORBIS_outofmem)));
			...
			f.mapping = (Mapping*) (setup_malloc(f, (int) (f.mapping_count*sizeof ((*f.mapping)))))
			;
			if ((f.mapping) == ((void*) (0))) return (int) (error(f, (int) (VORBIS_outofmem)));
			memset(f.mapping, (int) (0), (ulong) (f.mapping_count*sizeof ((*f.mapping))))
			;
			for (i = (int) (0); (i) < (f.mapping_count); ++i)
			{
				...
				m->chan = (MappingChannel*) (setup_malloc(f, (int) (f.channels*sizeof ((*m->chan)))))
				;
				if ((m->chan) == ((void*) (0))) return (int) (error(f, (int) (VORBIS_outofmem)));
			...
			for (i = (int) (0); (i) < (f.channels); ++i)
			{
				...
				f.finalY[i] = (short*) (setup_malloc(f, (int) (sizeof (int16)**longest_floorlist)));
				if ((((f.channel_buffers[i]) == ((void*) (0))) || ((f.previous_window[i]) == ((void*) (0)))) ||
				    ((f.finalY[i]) == ((void*) (0)))) return (int) (error(f, (int) (VORBIS_outofmem)));
			}
			...
			{
				uint imdct_mem = (uint) (f.blocksize_1*sizeof (float) >> >>
				1)
				;
				uint classify_mem;
				int i;
				...
				classify_mem = (uint) ((f.channels*(sizeof (void*) + +max_part_read*sizeof (uint8*)))))
				;
		...
		public static void vorbis_deinit(stb_vorbis p)
		{
			...
			if ((p.codebooks) != null)
			{
				for (i = (int) (0); (i) < (p.codebook_count); ++i)
				{
					...
					setup_free(p, c->sorted_values ? c->sorted_values - 1 : ((void*) (0)));
				}
		...
		{
			stb_vorbis p = (stb_vorbis) (setup_malloc(f, (int) (sizeof ((p)))))
			;
			return p;
		}
		...
		public static int vorbis_search_for_page_pushdata(stb_vorbis f, byte* data, int data_len)
		{
			...
			if ((f.page_crc_tests) < (4))
			{
				...
				for (i = (int) (0); (i) < (data_len); ++i)
				{
					if ((data[i]) == (0x4f))
					{
						if ((0) == (memcmp(data + i, ogg_page_header, (ulong) (4))))
						{
							int j;
							int len;
							uint crc;
							...
							if ((data[i + 27 + data[i + 26] - 1]) == (255)) f.scan[n].sample_loc = (uint) (~0);
							else
			...
			for (i = (int) (0);; (i) < (f.page_crc_tests))
			{
				...
				if ((m) > (data_len - n)) m = (int) (data_len - n);
				...
				if ((f.scan[i].bytes_left) == (0))
				{
					if ((f.scan[i].crc_so_far) == (f.scan[i].goal_crc))
					{
						...
						f.current_loc_valid = (int) (f.current_loc != ~0U);
						return (int) (data_len);
					}
		...
		public static int go_to_page_before(stb_vorbis f, uint limit_offset)
		{
			...
			while ((vorbis_find_page(f, &end, ((void*) (0)))) != 0)
			{
				...
				else
				{
					if ((probe) < (2))
					{
						...
						else
						{
							...
							if (((error) >= (0)) && ((error) < (8000))) error = (double) (8000);
							if (((error) < (0)) && ((error) > (-8000))) error = (double) (-8000);
					...
					if (vorbis_find_page(f, ((void*) (0)), ((void*) (0))) == 0) goto error;
				}
				for (;;)
				{
		...
		public static int stb_vorbis_get_frame_float(stb_vorbis f, int* channels, float*** output)
		{
			int len;
			int right;
			int left;
		...
		public static void copy_samples(short* dest, float* src, int len)
		{
			...
			for (i = (int) (0); (i) < (len); ++i)
			{
				float_conv temp = new float_conv();
				int v = (int) (temp.f = (float) ((src[i]) + (1.5f*(1 << (23 - 15)) + 0.5f/(1 << 15))), temp .
				i - (((150 - 15) << 23) + (1 << 22)))
				;
		...
		public static void compute_samples(int mask, short* output, int num_c, float** data, int d_offset, int len)
		{
			...
			{
				memset(buffer, (int) (0), (ulong) (sizeof ((buffer))))
				;
				...
				{
					float_conv temp = new float_conv();
					int v = (int) (temp.f = (float) ((buffer[i]) + (1.5f*(1 << (23 - 15)) + 0.5f/(1 << 15))), temp .
					i - (((150 - 15) << 23) + (1 << 22)))
					;
					if (((uint) (v + 32768)) > (65535)) v = (int) ((v) < (0) ? -32768 : 32767);
					output[o + i] = (short) (v);
			...
			int d_offset, int samples)
		{
			...
			else
			{
				...
				for (; (i) < (buf_c); ++i)
				{
					memset(buffer[i] + b_offset, (int) (0), (ulong) (sizeof (short)**samples));
				}
			}
		...
		{
			float** output;
			int len = (int) (stb_vorbis_get_frame_float(f, ((void*) (0)), &output));
		...
		public static void convert_channels_short_interleaved(int buf_c, short* buffer, int data_c, float** data, int d_offset,
			int len)
		{
			int i;
			if (((buf_c != data_c) && (buf_c <= 2)) && (data_c <= 6))
			...
			else
			{
				...
				for (j = (int) (0); (j) < (len); ++j)
				{
					for (i = (int) (0); (i) < (limit); ++i)
					{
						...
						int v = (int) (temp.f = (float) ((f) + (1.5f*(1 << (23 - 15)) + 0.5f/(1 << 15))), temp .
						i - (((150 - 15) << 23) + (1 << 22)))
						;
						if (((uint) (v + 32768)) > (65535)) v = (int) ((v) < (0) ? -32768 : 32767);
						*buffer++ = (short) (v);
		...
		public static int stb_vorbis_get_frame_short_interleaved(stb_vorbis f, int num_c, short* buffer, int num_shorts)
		{
			...
			len = (int) (stb_vorbis_get_frame_float(f, ((void*) (0)), &output));
			if ((len) != 0)
			{
		...
		public static int stb_vorbis_get_samples_short_interleaved(stb_vorbis f, int channels, short* buffer, int num_shorts)
		{
			...
			while ((n) < (len))
			{
				...
				if ((n) == (len)) break;
				if (stb_vorbis_get_frame_float(f, ((void*) (0)), &outputs) == 0) break;
			}
			return (int) (n);
		}
		...
		public static int stb_vorbis_decode_memory(byte* mem, int len, int* channels, int* sample_rate, short** output)
		{
			...
			int error;
			short* data;
			stb_vorbis v = stb_vorbis_open_memory(mem, (int) (len), &error, ((void*) (0)));
			if ((v) == ((void*) (0))) return (int) (-1);
			...
			*channels = (int) (v.channels);
			...
			total = (int) (limit);
			data = (short*) (malloc((ulong) (total*sizeof ((*data)))))
			;
			if ((data) == ((void*) (0)))
			{
				stb_vorbis_close(v);
			...
			for (;;)
			{
				...
				if ((offset + limit) > (total))
				{
					short* data2;
					total *= (int) (2);
					data2 = (short*) (realloc(data, (ulong) (total*sizeof ((*data)))))
					;
					if ((data2) == ((void*) (0)))
					{
						free(data);
		...
		public static int stb_vorbis_get_samples_float(stb_vorbis f, int channels, float** buffer, int num_samples)
		{
			...
			while ((n) < (num_samples))
			{
				...
				if ((k) != 0)
				{
					for (i = (int) (0); (i) < (z); ++i)
					{
						memcpy(buffer[i] + n, f.channel_buffers[i] + f.channel_buffer_start, (ulong) (sizeof (float)**k));
					}
					for (; (i) < (channels); ++i)
					{
						memset(buffer[i] + n, (int) (0), (ulong) (sizeof (float)**k));
					}
				}
				n += (int) (k);
				f.channel_buffer_start += (int) (k);

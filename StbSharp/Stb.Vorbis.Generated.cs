// Generated by Sichem at 28.04.2017 0:37:12
...
namespace StbSharp
{
	unsafe partial class Stb
	{
		...
		public static void* setup_malloc(stb_vorbis f, int sz)
		{
			...
			return (sz) != 0 ? malloc((ulong) (sz)) : (null);
		}
		...
		public static int codebook_decode_start(stb_vorbis f, Codebook* c)
		{
			...
			else
			{
				...
				if ((z) >= (0))
				{
					int n2 = (int) (c->codeword_lengths[z]);
					f.valid_bits -= (int) (n2);
					if ((f.valid_bits) < (0))
					{
						f.valid_bits = (int) (0);
				...
				(byte***)
					(make_block_array(
						(f.alloc.alloc_buffer != null
							...
							: _alloca((ulong) (f.channels*(sizeof (void*) + +(part_read*sizeof (byte*)))))), (int) (f.channels),
					...
					if ((ch) == (2))
					{
						while ((pcount) < (part_read))
						{
							...
							if ((pass) == (0))
							{
								...
								if ((f.valid_bits) < (10)) prep_huffman(f);
								q = (int) (f.acc & ((1 << 10) - 1));
								q = (int) (c2->fast_huffman[q]);
								if ((q) >= (0))
								{
									int n2 = (int) (c2->codeword_lengths[q]);
									f.acc >>= n;
									f.valid_bits -= (int) (n2);
									if ((f.valid_bits) < (0))
									{
								...
								{
									q = (int) (codebook_decode_scalar_raw(f, c2));
								}
					...
					if ((pass) == (0))
					{
						for (j = (int) (0); (j) < (ch); ++j)
						{
							if (do_not_decode[j] == 0)
							{
								...
								temp = (int) (c2->fast_huffman[temp]);
								if ((temp) >= (0))
								{
									int n2 = (int) (c2->codeword_lengths[temp]);
									f.acc >>= n;
									f.valid_bits -= (int) (n2);
									if ((f.valid_bits) < (0))
									{
								...
								{
									temp = (int) (codebook_decode_scalar_raw(f, c2));
								}
					...
					if ((get_bits(f, (int) (1))) != 0)
					{
						...
						for (j = (int) (0); (j) < (g->partitions); ++j)
						{
							...
							if ((cbits) != 0)
							{
								...
								if ((cval) >= (0))
								{
									int n2 = (int) (c->codeword_lengths[cval]);
									f.acc >>= n;
									f.valid_bits -= (int) (n2);
									if ((f.valid_bits) < (0))
									{
							...
							for (k = (int) (0); (k) < (cdim); ++k)
							{
								...
								if ((book) >= (0))
								{
									...
									if ((temp) >= (0))
									{
										int n2 = (int) (c->codeword_lengths[temp]);
										f.acc >>= n;
										f.valid_bits -= (int) (n2);
										if ((f.valid_bits) < (0))
										{
		...
		{
			float** output;
			int len = (int) (stb_vorbis_get_frame_float(f, (null), &output));
		...
		public static int stb_vorbis_get_frame_short_interleaved(stb_vorbis f, int num_c, short* buffer, int num_shorts)
		{
			...
			len = (int) (stb_vorbis_get_frame_float(f, (null), &output));
			if ((len) != 0)
			{
